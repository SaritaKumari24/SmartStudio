                    ...
                    <ul>
                        <li
                            ...
                            <img width="24" height="24"
                                src="https://img.icons8.com/material-rounded/24/eeeeee/dashboard-layout.png"
                        ...
                        <details class="mt-2">
                            <summary
                                ...
                                <img width="24" height="24"
                                    src="https://img.icons8.com/fluency-systems-filled/50/eeeeee/event.png"
                                    alt="event" />
                                <span class="text-[#eee] font-medium text-lg">Event</span>
                            </summary>
                            <ul class="pl-8">
                                <li
                                    class="flex items-center gap-3 hover:bg-gray-700 p-2 rounded transition duration-300">
                        ...
                        <details class="mt-2">
                            <summary
                                ...
                                <img width="24" height="24"
                                    ...
                                    alt="user-male-circle--v1" /> <span
                                    class="text-[#eee] font-medium text-lg">Customer</span>
                            </summary>
                            <ul class="pl-8">
                                <li
                                    class="flex items-center gap-3 hover:bg-gray-700 p-2 rounded transition duration-300">
                        ...
                        <li
                            ...
                            <img width="24" height="24"
                                src="https://img.icons8.com/ios-filled/50/eeeeee/settings.png" alt="settings" />
